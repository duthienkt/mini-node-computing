...
var BROWSER = [['coccoc', /coc\_coc\_browser\/([0-9.]+)/], // Microsoft Edge Browser, Default browser in Windows 10.
...
["maxthon", function () {
  ...
  return false;
}], ["oppobrowser", /\boppobrowser\/([0-9.]+)/], ["chrome", / (?:chrome|crios|crmo)\/([0-9.]+)/], // Android safari 
["android", function (ua) {
